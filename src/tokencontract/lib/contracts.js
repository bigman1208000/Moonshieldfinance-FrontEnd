...
import TokenContractBep20 from './abi/tokencontractBep20.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.TokenContractBep20 = new this.web3.eth.Contract(TokenContractBep20)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.TokenContractBep20, contractAddresses.TokenContractBep20[networkId])
  }

  setDefaultAccount(account) {
    this.TokenContractBep20.options.from = account
  }
