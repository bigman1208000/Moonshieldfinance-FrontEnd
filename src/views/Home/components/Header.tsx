                ...
                <div className="container">
                    ...
                    <div className="row d-flex align-items-center justify-content-center mb-5 flex-wrap" id="header-btns">
                        ...
                        <div className="col font-monospace flex-grow-1">
                            <a className="btn btn-primary font-monospace btn-xl rounded-pill btn-border bg-primary carbon-bg-gray" role="button" data-bs-toggle="tooltip" data-bss-tooltip="" href="http://localhost:3000/dashboard" title="Claim your $BNB here">
                                OPEN DAPP
                            </a>
                        </div>
                        <div className="col font-monospace flex-grow-1">
